 ...
 */
public class RegisterRD extends ActivityInstrumentationTestCase2{
    private Solo solo;
    ...
    public void testRun() {
        ...
        solo.enterText((android.widget.EditText) solo.getView(com.qicfix.qicfixapp.R.id.confirmPassRegForm), "abc");
